    ...
    foreach($registros as $fila){
        ...
        switch ($fila['estado']) {
            ...
            echo "  <td>".$fila['aula']."</td>
                    ...
                    <td>
                        <button type=\"button\" class=\"close\" aria-label=\"Close\" onclick=\"confirmarEliminacionHorario('".$fila['idMateria']."', '".$fila['aula']."', '".$fila['dia']."', '".$fila['modulo']."', '".$fila['horainicio']."', '".$fila['horafin']."', '".$fila['cuatrimestre']."')\">
                            <i class=\"material-icons\">
                                 clear
                            </i>
                        </button>
